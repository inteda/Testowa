...
use Testowy\TestowyBundle\Entity\Book;
use Testowy\TestowyBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestowyBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("TestowyBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestowyBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestowyBundle:Book:edit.html.twig")
     */
